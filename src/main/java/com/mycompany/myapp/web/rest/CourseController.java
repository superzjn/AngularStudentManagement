...
public class CourseController {
    ...
    @GetMapping(path = "/api/course/findAllCoursesLongerThanTen/{input}", produces = "application/json")
    public HttpEntity<List<CourseDto>> findAllCoursesLongerThanTen(@NotNull @PathVariable("input") String input){

        List<CourseDto> allCourses = courseService.findAllCoursesLongerThan(input);
